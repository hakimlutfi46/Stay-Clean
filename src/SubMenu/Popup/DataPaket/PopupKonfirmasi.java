 ...
 */
package SubMenu.Popup.DataPaket;
...
public class PopupKonfirmasi extends javax.swing.JFrame {
    ...
    public PopupKonfirmasi(String pesan, String id, JDesktopPane pane) {
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        lbl_pesan.setText("<html><center>" + pesan + "</center></html>");
        this.idDetailPaket = id;
        this.pane = pane;
    }
    ...
    private void btn_okeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_okeMouseClicked
        deleteDb("delete from detail_paket where id_detailPaket = '" + this.idDetailPaket + "'");
        this.dispose();
        new PopupSukses("Data berhasil dihapus", "dataPaket", this.pane).setVisible(true);
